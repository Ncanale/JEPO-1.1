...
for i in range (0,len(names)):  
    ...
    if plot_offsets:
        ...
        c3.Update()
        string = 'Smearing: ' + str(Smearing) +', Par 0: ' + str(funct.GetParameter(0)) + ', Par1: ' + str(funct.GetParameter(1)) + ', EPar 0: ' + str(funct.GetParError(0)) +', EPar 1: ' + str(funct.GetParError(1)) + '\n'
        print(string)
